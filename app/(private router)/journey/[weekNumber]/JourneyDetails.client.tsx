...
export default function JourneyDetails() {
  ...
  const { data: babyData, isLoading: isBabyLoading } = useQuery<BabyState>({
    queryKey: ["journeyDetails", weekNum, activeTab],
    queryFn: () => getBabyState(weekNum),
    enabled: activeTab === "baby",
    placeholderData: keepPreviousData,
  });

  const { data: momData, isLoading: isMomLoading } = useQuery<MomState>({
    queryKey: ["journeyDetails", weekNum, activeTab],
  ...
  console.log("MOM DATE", momData);

  console.log("BABY DATE", babyData);
    ...
    <>
      <div className={css.container}>
        <div className={css["btn-group"]}>
          <button
            className={
              activeTab === "baby" ? css["btn-active"] : css["btn-inactive"]
            }
          ...
          <button
            className={
              activeTab === "mom" ? css["btn-active"] : css["btn-inactive"]
            }
